...
public class MainHelper extends Activity {
    ...
    private ArrayList<NavAsideDrawerItem> navDrawerItems;
    private NavAsideDrawerListAdapter adapter;
    /* Navigation aside end */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.helper_main_drawer_layout);
        mDrawerList = (ListView) findViewById(R.id.helper_ban_aside_list_slidermenu);

        navDrawerItems = new ArrayList<NavAsideDrawerItem>();

        // adding nav drawer items to array
        // Home
        navDrawerItems.add(new NavAsideDrawerItem(navMenuTitles[0], navMenuIcons.getResourceId(0, -1)));
        // Calculator
        navDrawerItems.add(new NavAsideDrawerItem(navMenuTitles[1], navMenuIcons.getResourceId(1, -1)));
        // GameMemory
        ...
        adapter = new NavAsideDrawerListAdapter(getApplicationContext(),
                navDrawerItems);
    ...
    private void displayView(int position) {
        ...
        if (fragment != null) {
            ...
            Log.e("MainHelper", "Error in creating fragment");
        }
    }
